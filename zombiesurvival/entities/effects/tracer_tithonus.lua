...
function EFFECT:Render()
	...
	render.DrawBeam(self.StartPos, self.EndPos, 5, texcoord, texcoord + nlen / 128, Color(50, 255, 110, 255 * alpha))
	render.SetMaterial(glowmat)
	render.DrawSprite(self.EndPos, 50, 50, Color(50, 255, 110, 230 * alpha))
end
