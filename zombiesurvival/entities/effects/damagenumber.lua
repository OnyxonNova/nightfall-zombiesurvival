...
function EFFECT:Init(data)
	...
	if GAMEMODE.HitSounds and MySelf and Type ~= 1 then
		timer.Simple(amount / 2000, function()
			MySelf:EmitSound("zombiesurvival/hitsound.wav", 110, 105 - math.min(40,amount / 6), 1, CHAN_ITEM )
		end)
	end
end
