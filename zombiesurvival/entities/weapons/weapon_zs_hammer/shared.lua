...
SWEP.Description = "Нажмите ПКМ, чтобы забить гвоздь.\nНажмите R, чтобы вынуть гвоздь.\nИспользуйте ЛКМ, чтобы восстанавливать поврежденные баррикады получая за это Поинты."
