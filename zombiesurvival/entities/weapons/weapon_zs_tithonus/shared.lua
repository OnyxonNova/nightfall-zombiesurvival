...
SWEP.PrintName = "'Тифон' Зарядный Дробовик"
SWEP.Description = "Заряжает выстрел из дробовика импульсными снарядами."
...
SWEP.TracerName = "tracer_tithonus"

GAMEMODE:AttachWeaponModifier(SWEP, WEAPON_MODIFIER_RELOAD_SPEED, 0.02)
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'Тритон' Зарядный Дробовик", "Ориентирован на стрельбу быстро заряженными зарядами", function(wept)
	...
	wept.TracerName = "tracer_triton"
end)
branch.NewNames = {[0]="Тритон"}
