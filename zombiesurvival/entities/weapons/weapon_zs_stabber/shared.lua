...
SWEP.PrintName = "'Колющий' M1 Garand"
SWEP.Description = "Уникальный гибрид ближнего и дальнего боя, позволяет наносить неплохой урон дальним боем и добивать ближним."
...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'Прокол' M1 Garand", "Доп. урон по целям, недавно пораженным штыком", function(wept)
