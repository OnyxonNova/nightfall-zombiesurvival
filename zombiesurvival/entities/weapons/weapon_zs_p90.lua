...
SWEP.Description = "Удерживайте ПКМ, чтобы использовать штормовой режим стрельбы: скорострельность понижена до 60%, но стреляет двумя пулями за раз."
SWEP.Slot = 2
SWEP.SlotPos = 0
...
SWEP.IronSightsPos = Vector(-2.4, 0, 2)
