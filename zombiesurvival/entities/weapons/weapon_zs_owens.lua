...
SWEP.PrintName = "'Овен' Пистолет"
SWEP.Description = "Слегка менее точный пистолет стреляя двумя пулями с приличным уроном."
...
SWEP.IronSightsPos = Vector(-5.9, 3, 0.75)
SWEP.IronSightsAng = Vector(-0.15, -1, 1.6)
