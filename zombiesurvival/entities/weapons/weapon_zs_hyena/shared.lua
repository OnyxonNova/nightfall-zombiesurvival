SWEP.PrintName = "'Гиена' Миномет"
SWEP.Description = "Стреляет взрывчаткой которая, прилипает к поверхностям и врагам пока не взорвутся. Бомбам нужно 3 секунды, чтобы достигнуть максимального урона. Альтернативный режим стрельбы удаленно взорвет бомбы."
...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'Рысь' Миномет", "Запускает криобомбы, которые наносят меньше урона, но замедляют зомби", function(wept)
