...
SWEP.Description = "Несмотря на странный вид, оно довольно эффективное против зомби."
...
if CLIENT then
	...
	SWEP.WElements = {
		...
		["stick"] = { type = "Model", model = "models/props_docks/dock01_pole01a_128.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "base", pos = Vector(-1, 3, -18), angle = Angle(0, 0, 0), size = Vector(0.1, 0.1, 0.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
end
...
function SWEP:PlayRevupSound()
    self:EmitSound("physics/concrete/rock_impact_hard"..math.random(6)..".wav", 75, math.Rand(55, 65))
end
