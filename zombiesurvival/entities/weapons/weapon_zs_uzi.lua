...
SWEP.PrintName = "'Спрей' Узи 9мм"
SWEP.Description = "Довольно неточная, но дешевая и имеет хорошую огневую мощь."
...
SWEP.IronSightsPos = Vector(-6.6, 15, 1)
...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'Диспергатор' Узи 9мм", "Уменьшает размер обоймы, но увеличивает скорострельность", function(wept)
