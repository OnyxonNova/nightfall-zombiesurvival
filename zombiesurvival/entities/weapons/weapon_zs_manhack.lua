...
SWEP.PrintName = "Манхак"
SWEP.Description = "Развертываемое устройство с дистанционным управлением.\nИдеально подходит для разведки, но также может использоваться для атак из безопасного места.\nИмеет острые лезвия, пронзающие зомби."
...
SWEP.HitCooldown = 0.25
SWEP.DamageDrone = 35

SWEP.NoDeploySpeedChange = true
SWEP.AllowQualityWeapons = true

GAMEMODE:SetPrimaryWeaponModifier(SWEP, WEAPON_MODIFIER_DAMAGE_DRONE, 5.85)
GAMEMODE:AttachWeaponModifier(SWEP, WEAPON_MODIFIER_HIT_COOLDOWN, -0.05)
