...
SWEP.PrintName = "'Пролифератор' SMG"
SWEP.Description = "Удерживайте ПКМ, чтобы использовать штормовой режим стрельбы: скорострельность снижена до 60%, но выпускается более широкий веер пуль."
SWEP.Slot = 2
SWEP.SlotPos = 0
