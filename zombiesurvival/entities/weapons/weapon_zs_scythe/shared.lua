SWEP.PrintName = "Коса Смерти"
SWEP.Description = "Отличная коса, способная пронзить и прорезать нескольких зомби. Имеет комбо из 3 ударов, последний удар наносит дополнительный урон."
