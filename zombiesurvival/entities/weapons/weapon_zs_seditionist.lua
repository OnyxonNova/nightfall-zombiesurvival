...
SWEP.PrintName = "'Мятежник' Пистолет"
SWEP.Description = "Этот мощный пистолет способен пробить несколько зомби, но с плохим уроном по голове."
SWEP.Slot = 1
SWEP.SlotPos = 0
...
if CLIENT then
	...
	SWEP.HUD3DPos = Vector(-1.85, 0, 1)
	SWEP.HUD3DAng = Angle(0, 0, 0)
	SWEP.HUD3DScale = 0.015

	SWEP.IronSightsPos = Vector(-6.35, 5, 0.79)
