...
SWEP.PrintName = "Кастет"
SWEP.Description = "Пара латунных кастетов для усиления ударов кулаками, увеличивает наносимый урон, сохраняя при этом скорость передвижения."
