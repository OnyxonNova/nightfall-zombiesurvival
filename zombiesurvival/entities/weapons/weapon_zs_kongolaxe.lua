...
SWEP.PrintName = "'Конгол' Топор"
SWEP.Description = "Очень тяжелый великий топор без каких-либо других особых свойств, кроме нанесения чистого урона."
