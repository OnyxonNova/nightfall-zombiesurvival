...
SWEP.PrintName = "'Нова Кольт' Револьвер"
SWEP.Description = "Тяжелый пистолет, который наносит внушительный взрывной урон, но имеет значительное время перезарядки."
SWEP.Slot = 1
SWEP.SlotPos = 0
...
function SWEP.BulletCallback(attacker, tr, dmginfo)
	...
	if SERVER and ent and ent:IsValidLivingZombie() then
		dmginfo:SetDamageForce(attacker:GetUp() * 10000 + attacker:GetForward() * 50000)
	end
end
