...
SWEP.PrintName = "'P228' Пистолет"
SWEP.Description = "Имеет низкий урон, но использует половину патрон."
...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'Воробей' Авто. Пистолет", "Полностью автоматический", function(wept)
...
branch.NewNames = {[0]="Воробей"}

SWEP.IronSightsPos = Vector(-5.95, 0, 1)
