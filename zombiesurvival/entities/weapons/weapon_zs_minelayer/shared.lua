SWEP.PrintName = "'Падаль' Миномет"
SWEP.Description = "Миномет стреляющий простыми минами которые прилипают к стене."
...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'Бенгальский Огонь' Лазерный Минер", "Разрушительные лазерные мины, которые действуют несколько секунд", function(wept)
...
branch.NewNames = {[0]="Бенгальск. Огонь"}
