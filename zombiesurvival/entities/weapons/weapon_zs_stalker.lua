...
SWEP.PrintName = "'M4' Штурмовая Винтовка"
SWEP.Description = "Винтовка с глушителем которая скрывает вашу ауру на средних дистанциях."
SWEP.Slot = 2
SWEP.SlotPos = 0
...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'Претендент' M4", "Увеличен урон, стреляет более медленной и точной очередью из 3 пулями", function(wept)
