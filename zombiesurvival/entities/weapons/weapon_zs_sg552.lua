...
SWEP.PrintName = "'SG-550' Штурм. Винтовка"
SWEP.Description = "У этого оружия увеличенный урон в голову, но медленный темп огня."
...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'Товарищ' Винтовка Микронавта", "Уменьшена точность, урон, но увеличен размер магазина и выпущены доп. снаряды", function(wept)
...
branch.NewNames = {[0]="Товарищ"}
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 2, "'Горизонт' Боевая Винтовка", "Чрезвычайно точный, больше урона и стреляет медленными очередями", function(wept)
...
branch.Colors = {[0]=Color(130, 180, 190), [1]=Color(110, 160, 170), [2]=Color(90, 140, 150), [3]=Color(70, 120, 130)}
branch.NewNames = {[0]="Горизонт", [1]="Фокусировка", [2]="Застывший", [3]="Орфический"}
