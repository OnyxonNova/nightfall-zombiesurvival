...
SWEP.PrintName = "'UMP-45' SMG"
SWEP.Description = "После убийства со жнеца урон увеличивается на 8%"
...
if CLIENT then
	...
	SWEP.HUD3DPos = Vector(-1.5, -3, 0)
	SWEP.HUD3DAng = Angle(0, 0, 0)
	SWEP.HUD3DScale = 0.02

	SWEP.VMPos = Vector(-1, -3, 1.75)
end
...
SWEP.IronSightsPos = Vector(-3.2, -1, 4.25)
SWEP.IronSightsAng = Vector(-1, 0.2, 0)

SWEP.IsReaper = true

GAMEMODE:AttachWeaponModifier(SWEP, WEAPON_MODIFIER_FIRE_DELAY, -0.010)
