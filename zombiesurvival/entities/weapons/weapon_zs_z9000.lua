...
SWEP.PrintName = "'Z9000' Импульсный Пистолет"
SWEP.Description = "Пусть и Z9000 не наносит достаточного урона, но импульсные патроны замедляют цель."
...
if CLIENT then
	...
	SWEP.VMPos = Vector(0, -4, 1.25)

	SWEP.VElements = {
		["base"] = { type = "Model", model = "models/weapons/w_alyx_gun.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(7, 2, -4.092), angle = Angle(175, 10, 10), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
end
