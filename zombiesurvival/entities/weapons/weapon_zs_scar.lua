...
SWEP.PrintName = "'Терминус' SCAR"
SWEP.Description = "Мощная штурмовая винтовка, которая становится более точной с каждым выстрелом в обойме, стреляет по 2 патрона."
