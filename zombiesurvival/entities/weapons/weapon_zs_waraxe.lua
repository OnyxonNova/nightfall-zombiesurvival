...
SWEP.PrintName = "'Боевой Топор' Пистолет"
SWEP.Description = "Имеет значительный урон и скорострельность, стреляет по 4 пули за раз."
...
SWEP.ViewModel = "models/weapons/zs/c_glock_reanim.mdl"
...
SWEP.IronSightsPos = Vector(-4.65, 0, 1)

SWEP.WalkSpeed = SPEED_NORMAL

GAMEMODE:AttachWeaponModifier(SWEP, WEAPON_MODIFIER_CLIP_SIZE, 1, 1)
GAMEMODE:AttachWeaponModifier(SWEP, WEAPON_MODIFIER_HEADSHOT_MULTI, 0.07)
GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'Партизан' Пистолет", "Наносит доп. урон зомби с полным здоровьем, но меньший общий урон", function(wept)
