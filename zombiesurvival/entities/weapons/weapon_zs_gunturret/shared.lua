...
SWEP.PrintName = "Автоматная Турель"
SWEP.Description = "Эта автоматизированная турель требует постоянного обслуживания, чтобы быть полезной.\nНажмите ЛКМ, чтобы поставить турель.\nНажмите ПКМ или R, чтобы повернуть турель.\nНажмите E на развернутой турели, чтобы дать ей часть ваших боеприпасов."
