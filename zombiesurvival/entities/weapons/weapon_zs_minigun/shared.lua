SWEP.PrintName = "'Миниган' Пулемёт"
SWEP.Description = "Невероятно тяжелый миниган. Требуется время для намотки. Удерживайте ПКМ, чтобы намотать миниган без стрельбы."
...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'Цитадель' Мини-Пушка", "Использует 3 патрона на выстрел, стреляет медленнее, но больше урона и точности", function(wept)
