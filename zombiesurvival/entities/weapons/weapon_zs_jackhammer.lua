...
SWEP.PrintName = "'Барабан' Дробовик"
SWEP.Description = "Автоматический дробовик с огромным магазином."
...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'Наковальня' Дробовик", "Использует сразу 3 снаряда, урон чуть больше, точность снижена", function(wept)
	wept.Primary.NumShots = wept.Primary.NumShots * 3
	wept.Primary.Delay = wept.Primary.Delay * 3.3
	wept.Primary.Damage = wept.Primary.Damage * 1.085
	wept.RequiredClip = 3
	wept.Recoil = 10
