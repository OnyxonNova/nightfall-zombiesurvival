...
SWEP.PrintName = "'Мертвец' Дробовик-Обрез"
SWEP.Description = "Может стрелять двумя патронами, нанося вблизи огромный урон."
...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'Осколок' Винтовка", "Один точный пулевой снаряд, меньший общий урон", function(wept)
	wept.Primary.Damage = wept.Primary.Damage * 5.5
	wept.Primary.NumShots = 1
	wept.ConeMin = wept.ConeMin * 0.15
	wept.ConeMax = wept.ConeMax * 0.3
end)
branch.NewNames = {[0]="Осколок"}
