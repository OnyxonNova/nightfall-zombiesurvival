...
SWEP.Description = "Позволяет удаленное наблюдение за другими облястями. Зомби не могут видеть камеру, если они не находятся очень близко.\nНажмите ЛКМ, чтобы поставить камеру."
