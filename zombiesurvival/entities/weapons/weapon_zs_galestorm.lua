...
SWEP.PrintName = "'Торнадо' SMG"
SWEP.Description = "Удерживайте ПКМ, чтобы использовать штормовой режим стрельбы: скорострельность снижена до 60%, но выстреливаются сразу две пули."
SWEP.Slot = 2
SWEP.SlotPos = 0
...
SWEP.IronSightsPos = Vector(-6, 15, 1)
SWEP.IronSightsAng = Vector(3, -4, -13)
...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'Вихрь' Душевая Винтовка", "Использует патроны для винтовки, стреляет медленнее, но с большим уроном", function(wept)
