...
SWEP.PrintName = "Силовые Перчатки"
SWEP.Description = "Пара силовых кулаков. Они медленнее, чем обычные кулаки, но обладают мощным импульсным ударом."
