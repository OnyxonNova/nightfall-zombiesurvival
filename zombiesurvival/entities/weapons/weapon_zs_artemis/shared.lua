SWEP.PrintName = "'Артемида' Арбалеты"
SWEP.Description = "Пара миниатюрных арбалетов. Стреляет быстрой последовательностью взрывных болтов."
...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'Актеон' Арбалеты", "Болты слегка пронзают, а не взрываются, и наносят урон уязвимости, меньший урон", function(wept)
