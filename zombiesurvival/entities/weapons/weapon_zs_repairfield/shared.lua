...
SWEP.Description = "Ремонтное поле, которое медленно восстанавливает все опоры в радиусе с помощью импульсной энергии. Расходует импульсные патроны.\nНажмите ЛКМ, чтобы поставить поле.\nНажмите ПКМ или R, чтобы повернуть поле."
