...
SWEP.PrintName = "'Квазар' Снайперская Винтовка"
SWEP.Description = "Импульсная снайперская винтовка замедляющая цель."
...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'Блазар' Трехствольная Винтовка", "Стреляет 3 импульсными выстрелами в линию с большим общим уроном", function(wept)
