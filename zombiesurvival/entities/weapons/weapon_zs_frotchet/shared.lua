SWEP.PrintName = "Фротчет"
SWEP.Description = "Вторичная атака создает ледяной взрыв, когда он нацелен на землю.\nЗамедляет движение зомби и скорость атаки."
