...
SWEP.PrintName = "'ASMD' Ударная Винтовка"
SWEP.Description = "Футуристичная снайперская винтовка.\nПКМ позволяет запустить по зомби импульсный шар.\nСтрельните по шару чтобы его взорвать и нанести дополнительный урон в округе"
...
function SWEP:TakeAmmo(secondary)
	self:TakePrimaryAmmo(secondary and 10 or 2)
end
...
function SWEP:SecondaryAttack()
	...
	if SERVER then
		self:ShootSecondary(self.Primary.Damage * 1.23, 1, self:GetCone()/3)
	end
