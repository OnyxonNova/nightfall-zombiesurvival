...
SWEP.PrintName = "'Колосс' Драйвер"
SWEP.Description = "Выпускает винтовочные патроны с чрезвычайно высокой скоростью, пробивая несколько целей."
...
function SWEP:ShootBullets(dmg, numbul, cone)
	...
	local dmgf = function(i) return dmg * (1 - 0.15 * i) end
