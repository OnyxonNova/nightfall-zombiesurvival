...
SWEP.PrintName = "'Стрелок' SMG"
SWEP.Description = "Относительно простой пистолет-пулемет с приличным скорострельностью и перезарядкой."
...
if CLIENT then
	...
	SWEP.HUD3DPos = Vector(1.7, 0.25, -2)
...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'Метатель' Взрывной SMG", "Увеличенный урон, но SMG стреляет очередями", function(wept)
