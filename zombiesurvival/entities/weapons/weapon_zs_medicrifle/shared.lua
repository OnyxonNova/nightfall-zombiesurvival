SWEP.PrintName = "Мед. Карабин"
SWEP.Description = "Быстрые дротики-бакты, которые повышают защиту и исцеляют на расстоянии.\nПоглощённый урон с защиты даёт вам поинты."
SWEP.Slot = 4
SWEP.SlotPos = 0
...
SWEP.DefenceGun = true

GAMEMODE:SetPrimaryWeaponModifier(SWEP, WEAPON_MODIFIER_HEALING, 0.7)
GAMEMODE:AttachWeaponModifier(SWEP, WEAPON_MODIFIER_BUFF_DURATION, 2)
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'Инвигоратор' Винтовка", "Повышает силу заместо защиты.\nВы получаете поинты за урон, нанесённый теми, кого вы усилили.", function(wept)
	wept.StrengthGun = true
	wept.DefenceGun = false
	if SERVER then
