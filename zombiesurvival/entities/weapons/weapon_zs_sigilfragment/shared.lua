SWEP.PrintName = "Кусочек Маяка"
SWEP.Description = "Таинственный камень, обладающий некоторой властью над миром.\nВозвращает вас к любому маяку, на который вы указываете."
...
SWEP.DroppedColorModulation = Color(85, 170, 255)
...
function SWEP:PrimaryAttack()
	...
	if SERVER then
		...
		if status:IsValid() then
			...
			status:SetFromSigilFragment(true)
