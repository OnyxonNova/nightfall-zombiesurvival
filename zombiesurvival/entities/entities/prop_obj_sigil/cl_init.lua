...
local matOver = Material("models/props_combine/portalball001_sheet")
...
function ENT:DrawTranslucent()
	...
	-- Draw the model with the default material
	self:DrawModel()

	render_SetColorModulation(r, g, b)

	render_ModelMaterialOverride(matOver)
	render_SetBlend(1 * healthperc)
	self:DrawModel()
	...
	particle:SetStartSize(math.Rand(8, 15) * (corrupt and 1 or 1) * scale)
