...
function ENT:RenderScreenspaceEffects()
	...
	colModDimVision["$pp_colour_addb"] = self:GetPower() * 0.07
	colModDimVision["$pp_colour_addg"] = self:GetPower() * -0.0175
	colModDimVision["$pp_colour_addr"] = self:GetPower() * -0.0455
