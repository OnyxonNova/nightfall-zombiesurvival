...
killicon.Add("redeem", "zombiesurvival/killicons/redeem_v2")

killicon.Add("weapon_zs_zombie", "zombiesurvival/killicons/zombie")
killicon.Add("weapon_zs_elder_zombie", "zombiesurvival/killicons/zombie", Color( 66, 0, 0, 255 ) )
...
killicon.Add("weapon_zs_superzombieze", "zombiesurvival/killicons/fresh_dead")
killicon.Add("weapon_zs_superzombiezs", "zombiesurvival/killicons/fresh_dead")
...
killicon.Add("weapon_zs_pukepus", "zombiesurvival/killicons/pukepus_new", Color(220, 220, 220))
...
killicon.Add("projectile_poisonpuke", "zombiesurvival/killicons/pukepus_new", Color(220, 220, 220))
...
killicon.Add("weapon_zs_flayer", "zombiesurvival/killicons/lacerator", Color( 255, 20, 0, 255 ) )
killicon.Add("weapon_zs_super_flayer", "zombiesurvival/killicons/lacerator", Color( 255, 20, 0, 255 ) )
killicon.Add("weapon_zs_hunterboss", "zombiesurvival/killicons/bonemesh", Color( 255, 20, 0, 255 ) )
...
killicon.Add("weapon_zs_eradicator", "zombiesurvival/killicons/zombie", Color(45, 0, 0))
...
killicon.Add("weapon_zs_frigidlurker", "zombiesurvival/killicons/skeletal_lurker", Color(50, 90, 135))
killicon.Add("weapon_zs_cryogenzombie", "zombiesurvival/killicons/skeletal_walker", Color(0, 100, 90))
killicon.Add("weapon_zs_cryogenlurker", "zombiesurvival/killicons/skeletal_lurker", Color(0, 100, 90))
...
killicon.Add("weapon_zs_clover", "zombiesurvival/killicons/nightmare")
killicon.Add("weapon_zs_investigator", "zombiesurvival/killicons/skeletal_walker", Color(0, 0, 0))
killicon.Add("weapon_zs_warden", "zombiesurvival/killicons/howler", Color(180, 45, 0))
killicon.Add("weapon_zs_spectra", "zombiesurvival/killicons/wraithv2", Color(102, 0, 102))
killicon.Add("weapon_zs_frostmarrow", "zombiesurvival/killicons/skeletal_walker", Color(30, 30, 200))
killicon.Add("weapon_zs_lancer", "zombiesurvival/killicons/skeletal_walker", Color(185, 25, 25))
killicon.Add("weapon_zs_burster", "zombiesurvival/killicons/chemzombie")
killicon.Add("weapon_zs_annihilator", "zombiesurvival/killicons/zombie", Color(45, 0, 0))
killicon.Add("weapon_zs_zombine", "zombiesurvival/killicons/zs_zombine")
killicon.Add("weapon_zs_bigfleshcreeper", "zombiesurvival/killicons/fleshcreeper", Color(255, 20, 0))
killicon.Add("weapon_zs_formidableghoul", "zombiesurvival/killicons/ghoul", Color(120, 40, 100))
...
killicon.AddFont("weapon_zs_scout", "zsdeathnoticecs", "n")
killicon.AddFont("weapon_zs_zestubber", "zsdeathnoticecs", "n")
killicon.AddFont("weapon_zs_awp", "zsdeathnoticecs", "r")
...
killicon.AddFont("weapon_zs_fiveseven", "zsdeathnoticecs", "u")
...
killicon.AddFont("weapon_zs_m3", "zsdeathnoticecs", "k")
...
killicon.AddFont("weapon_zs_p90", "zsdeathnoticecs", "m")
...
killicon.AddFont("weapon_zs_glock18", "zsdeathnoticecs", "c")
...
killicon.AddFont("weapon_zs_p228", "zsdeathnoticecs", "a")
killicon.AddFont("weapon_zs_mp5", "zsdeathnoticecs", "x")
killicon.AddFont("weapon_zs_zesmg", "zsdeathnoticecs", "x")
killicon.AddFont("weapon_zs_knife", "zsdeathnoticecs", "j")
killicon.AddFont("weapon_zs_zeknife", "zsdeathnoticecs", "j")
killicon.AddFont("weapon_zs_uzi", "zsdeathnoticecs", "l")
killicon.AddFont("weapon_zs_aug", "zsdeathnoticecs", "e")
killicon.AddFont("weapon_zs_zeinferno", "zsdeathnoticecs", "e")
killicon.AddFont("weapon_zs_stalker", "zsdeathnoticecs", "w")
killicon.AddFont("weapon_zs_zem4", "zsdeathnoticecs", "w")
killicon.AddFont("weapon_zs_ump45", "zsdeathnoticecs", "q")
killicon.AddFont("weapon_zs_famas", "zsdeathnoticecs", "t")
killicon.AddFont("weapon_zs_pulserifle", "zsdeathnotice", "2")
killicon.AddFont("weapon_zs_ak47", "zsdeathnoticecs", "b")
killicon.AddFont("weapon_zs_zeakbar", "zsdeathnoticecs", "b")
killicon.AddFont("weapon_zs_ender", "zsdeathnoticecs", "v")
killicon.AddFont("weapon_zs_dualpistol", "zsdeathnoticecs", "s")
killicon.AddFont("weapon_zs_m249", "zsdeathnoticecs", "z")
killicon.AddFont("weapon_zs_sg552", "zsdeathnoticecs", "A")
...
killicon.Add("weapon_zs_chizick", "zombiesurvival/killicons/reklama")
killicon.Add("weapon_zs_chijick", "zombiesurvival/killicons/reklama")
killicon.Add("weapon_zs_drumgun", "zombiesurvival/killicons/weapon_zs_aa12")
...
killicon.AddFont("weapon_zs_g3sg1", "zsdeathnoticecs", "i")
...
killicon.Add("weapon_zs_minigun", "zombiesurvival/killicons/weapon_zs_bulwark2")
...
killicon.Add("weapon_zs_medicrifle", "zombiesurvival/killicons/weapon_zs_convalescence", Color(64, 255, 67))
...
killicon.Add("weapon_zs_antidoteshot", "zombiesurvival/killicons/weapon_zs_purger.png", Color(64, 255, 67))
...
killicon.Add("weapon_zs_healingray", "zombiesurvival/killicons/weapon_zs_healingray.png", Color(64, 255, 67))
killicon.Add("weapon_zs_proliferator", "zombiesurvival/killicons/weapon_zs_proliferator.png")
killicon.Add("weapon_zs_pollutor", "zombiesurvival/killicons/weapon_zs_proliferator.png", Color(122, 250, 90))
killicon.Add("weapon_zs_pollutant", "zombiesurvival/killicons/weapon_zs_pollutant", Color(122, 250, 90))
...
killicon.Add("weapon_zs_knight", "zombiesurvival/killicons/skeletal_walker", Color(220, 200, 150))
...
killicon.Add("weapon_zs_giantspoon", "zombiesurvival/killicons/weapon_zs_shovel")
...
killicon.Add("weapon_zs_ballbat", "zombiesurvival/killicons/weapon_zs_baseballbat")
killicon.Add("weapon_zs_kroket", "zombiesurvival/killicons/weapon_zs_kroket")
...
killicon.Add("weapon_zs_medicalkit", "zombiesurvival/killicons/weapon_zs_medkit", Color(64, 255, 67))
killicon.Add("weapon_zs_medicalkitblood", "zombiesurvival/killicons/weapon_zs_medkit", Color(235, 65, 65))
killicon.Add("weapon_zs_medicgun", "zombiesurvival/killicons/weapon_zs_medicgun2", Color(64, 255, 67))
killicon.Add("weapon_zs_arsenalcrate", "zombiesurvival/killicons/weapon_zs_arsenalcrates")
killicon.Add("weapon_zs_remantler", "zombiesurvival/killicons/weapon_zs_remantler2.png")
killicon.Add("weapon_zs_propmaker", "zombiesurvival/killicons/weapon_zs_propmaker")
...
killicon.Add("weapon_zs_resupplybox", "zombiesurvival/killicons/weapon_zs_resupplyboxs")
...
killicon.Add("weapon_zs_mediccloudbomb", "zombiesurvival/killicons/weapon_zs_mediccloudbomb", Color(64, 255, 67))
...
killicon.Add("weapon_zs_f_banana", "zombiesurvival/killicons/food", Color(255, 0, 255))
killicon.Add("weapon_zs_f_water", "zombiesurvival/killicons/food", Color(255, 0, 255))
killicon.Add("weapon_zs_f_milk", "zombiesurvival/killicons/food", Color(255, 0, 255))
killicon.Add("weapon_zs_f_orange", "zombiesurvival/killicons/food", Color(255, 0, 255))
killicon.Add("weapon_zs_f_soda", "zombiesurvival/killicons/food", Color(255, 0, 255))
killicon.Add("weapon_zs_f_watermelon", "zombiesurvival/killicons/food", Color(255, 0, 255))
killicon.Add("weapon_zs_f_takeout", "zombiesurvival/killicons/food", Color(255, 0, 255))
killicon.Add("weapon_zs_f_beer", "zombiesurvival/killicons/weapon_zs_f_beer", Color(255, 0, 255))
killicon.Add("weapon_zs_sigilfragment", "zombiesurvival/killicons/sigil_fragment", Color(85, 170, 255))
...
killicon.Add("ammo_medpower", "zombiesurvival/killicons/medpower_ammo_icon", Color(64, 255, 67))
killicon.Add("ammo_nail", "zombiesurvival/killicons/nail_ammo_icon_2", Color(175, 175, 175))
killicon.Add("ammo_plank", "zombiesurvival/killicons/plank_ammo", Color(149, 187, 219))

killicon.Add("weapon_zs_savior", "zombiesurvival/killicons/weapon_zs_savior", Color(64, 255, 67))

killicon.Add("weapon_zs_creator", "zombiesurvival/killicons/weapon_zs_creator")
killicon.Add("weapon_zs_glimpser", "zombiesurvival/killicons/weapon_zs_glimpser")
killicon.Add("weapon_zs_razor", "zombiesurvival/killicons/weapon_zs_razor")
killicon.Add("weapon_zs_piercer", "zombiesurvival/killicons/weapon_zs_piercer")

killicon.Add("weapon_zs_healthkit", "zombiesurvival/killicons/weapon_zs_healthkit", Color(64, 255, 67))
killicon.Add("weapon_zs_pickaxe", "zombiesurvival/killicons/weapon_zs_pickaxe")
killicon.Add("weapon_zs_adrenalineshot", "zombiesurvival/killicons/weapon_zs_adrenaline")

killicon.Add("weapon_zs_impulsehammer", "zombiesurvival/killicons/weapon_zs_impulsehammer")
killicon.Add("weapon_zs_zweihand", "zombiesurvival/killicons/weapon_zs_zweihand")
killicon.Add("weapon_zs_ganymede", "zombiesurvival/killicons/weapon_zs_epimetheus")

killicon.Add("weapon_zs_magnet", "zombiesurvival/killicons/weapon_zs_trinket_magnet")
killicon.Add("weapon_zs_nightvision", "zombiesurvival/killicons/weapon_zs_trinket_nightvision")

killicon.Add("trinket_aimcomp", "zombiesurvival/killicons/weapon_zs_trinket_aimcomp")
killicon.Add("trinket_sightingvisor", "zombiesurvival/killicons/weapon_zs_trinket_sightingvisor")
killicon.Add("trinket_holster", "zombiesurvival/killicons/weapon_zs_trinket_holster")
killicon.Add("trinket_cartridgebelt", "zombiesurvival/killicons/weapon_zs_trinket_cartridgebelt")
killicon.Add("trinket_impulseinfuser", "zombiesurvival/killicons/weapon_zs_trinket_impulseinfuser")

killicon.Add("trinket_forcedamp", "zombiesurvival/killicons/weapon_zs_trinket_forcedamp")
killicon.Add("trinket_eodvest", "zombiesurvival/killicons/weapon_zs_trinket_eodvest")
killicon.Add("trinket_bodyarmor", "zombiesurvival/killicons/weapon_zs_trinket_bodyarmor")
killicon.Add("trinket_bandage", "zombiesurvival/killicons/weapon_zs_trinket_bandage")
killicon.Add("trinket_antitoxinpack", "zombiesurvival/killicons/weapon_zs_trinket_antitoxinpack")
killicon.Add("trinket_reactiveflasher", "zombiesurvival/killicons/weapon_zs_trinket_reactiveflasher")

killicon.Add("trinket_bloodbank", "zombiesurvival/killicons/weapon_zs_trinket_bloodbank")
killicon.Add("trinket_healthpack", "zombiesurvival/killicons/weapon_zs_trinket_survivalpack")
killicon.Add("trinket_cutlery", "zombiesurvival/killicons/weapon_zs_trinket_cutlery")
killicon.Add("trinket_biocleanser", "zombiesurvival/killicons/weapon_zs_trinket_biocleanser")
killicon.Add("trinket_regenimplant", "zombiesurvival/killicons/weapon_zs_trinket_regenimplant")

killicon.Add("trinket_strengthenedswing", "zombiesurvival/killicons/weapon_zs_trinket_strengthenedswing")
killicon.Add("trinket_adrenalinerush", "zombiesurvival/killicons/weapon_zs_trinket_adrenalinerush")
killicon.Add("trinket_longgrip", "zombiesurvival/killicons/weapon_zs_trinket_longgrip")
killicon.Add("trinket_powergauntlet", "zombiesurvival/killicons/weapon_zs_trinket_powergauntlet")

killicon.Add("trinket_oxygentank", "zombiesurvival/killicons/weapon_zs_trinket_oxygentank")
killicon.Add("trinket_agilitymagnifier", "zombiesurvival/killicons/weapon_zs_trinket_agilitymagnifier")
killicon.Add("trinket_featherfallboots", "zombiesurvival/killicons/weapon_zs_trinket_featherfallboots")
killicon.Add("trinket_weights", "zombiesurvival/killicons/weapon_zs_trinket_weights")
killicon.Add("trinket_exoskeleton", "zombiesurvival/killicons/weapon_zs_trinket_exoskeleton")
killicon.Add("trinket_nightvision", "zombiesurvival/killicons/weapon_zs_trinket_nightvision")
killicon.Add("trinket_analgesic", "zombiesurvival/killicons/weapon_zs_trinket_analgesic")

killicon.Add("trinket_acqmanifest", "zombiesurvival/killicons/weapon_zs_trinket_acquisitionsmanifest")
killicon.Add("trinket_blueprints", "zombiesurvival/killicons/weapon_zs_trinket_blueprints")
killicon.Add("trinket_processor", "zombiesurvival/killicons/weapon_zs_trinket_processor")
killicon.Add("trinket_matrixchip", "zombiesurvival/killicons/weapon_zs_trinket_matrixchip")
killicon.Add("trinket_controlplat", "zombiesurvival/killicons/weapon_zs_trinket_controlplatform")
killicon.Add("trinket_arsenalpack", "zombiesurvival/killicons/weapon_zs_arsenalcrates")

killicon.Add("trinket_bleaksoul", "zombiesurvival/killicons/weapon_zs_trinket_breaksoul")
killicon.Add("trinket_barbedarmor", "zombiesurvival/killicons/weapon_zs_trinket_barbedarmor")
killicon.Add("trinket_escapemanual", "zombiesurvival/killicons/weapon_zs_trinket_escapemanual")

killicon.Add("ps_crystal", "zombiesurvival/killicons/weapon_zs_ps_crystal")
...
net.Receive("zs_pl_kill_pl", function(length)
	...
	if victim:IsValid() and attacker:IsValid() then
		...
		MsgC(team.GetColor(attackerteam), attackername, color_white, " убил ", team.GetColor(victimteam), victimname, color_white, " с помощью ", COLOR_YELLOW, inflictor, "\n")
...
net.Receive("zs_pls_kill_pl", function(length)
	...
	if victim:IsValid() and attacker:IsValid() and assister:IsValid() then
		...
		MsgC(team.GetColor(attackerteam), attackername, " и ", team.GetColor(attackerteam), assistername, color_white, " убили ", team.GetColor(victimteam), victimname, color_white, " с помощью ", COLOR_YELLOW, inflictor, "\n")

		GAMEMODE:TopNotify(attacker, " и ", assister, " ", {killicon = inflictor, headshot = headshot}, " ", victim)
	end
end)
...
net.Receive("zs_pl_kill_self", function(length)
	...
	if victim:IsValid() then
		...
		MsgC(team.GetColor(victimteam), victimname, color_white, " убил себя", "\n")
...
net.Receive("zs_playerredeemed", function(length)
	...
	if pl:IsValid() then
		...
		if pl == MySelf then
			GAMEMODE:CenterNotify(COLOR_CYAN, " ", {killicon = "redeem"}, translate.Get("you_redeemed"), " ", {killicon = "redeem"})
...
net.Receive("zs_death", function(length)
	...
	if victim:IsValid() then
		...
		MsgC(team.GetColor(victimteam), victimname, color_white, " был убит игроком ", COLOR_YELLOW, attacker, color_white, " с помощью ", COLOR_YELLOW, inflictor, "\n")

		GAMEMODE:TopNotify(COLOR_RED, attacker, " ", {deathicon = inflictor}, " ", victim)
	end
end)

net.Receive("zs_human_kill_nest", function(length)
	local attacker = net.ReadEntity()
	local attackerteam = net.ReadUInt(8)
	local inflictor = net.ReadString()
	...
	if attacker:IsValid() then
		local attackername = attacker:Name()
		GAMEMODE:TopNotify(attacker, " ", {killicon = inflictor}, " ", {killicon = "nest"}, COLOR_SOFTRED, "Гнездо")

		MsgC(team.GetColor(attackerteam), attackername, color_white, " уничтожил ", Color(235, 65, 65), "Гнездо", color_white, " с помощью ", COLOR_YELLOW, inflictor, "\n")
	end
end)