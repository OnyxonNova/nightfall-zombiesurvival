...
SKIN.colScrollBar	= Color(50, 50, 50, 255) 
...
function SKIN:PaintVScrollBar( panel, w, h )
	...
	self.tex.Scroller.TrackV( 0, 0, w, h, self.colTab )
...
function SKIN:PaintScrollBarGrip( panel, w, h )
	...
	if ( panel:GetDisabled() ) then
		return self.tex.Scroller.ButtonV_Disabled( 0, 0, w, h, self.colScrollBar )
	end

	if ( panel.Depressed ) then
		return self.tex.Scroller.ButtonV_Down( 0, 0, w, h, self.colScrollBar )
	end

	if ( panel.Hovered ) then
		return self.tex.Scroller.ButtonV_Hover( 0, 0, w, h, self.colScrollBar )
	end

	return self.tex.Scroller.ButtonV_Normal( 0, 0, w, h, self.colScrollBar )
...
function SKIN:PaintButtonDown( panel, w, h )
	...
	if ( panel.Depressed || panel:IsSelected() ) then
		return self.tex.Scroller.DownButton_Down( 0, 0, w, h, self.colScrollBar )
	end

	if ( panel:GetDisabled() ) then
		return self.tex.Scroller.DownButton_Dead( 0, 0, w, h, self.colScrollBar )
	end

	if ( panel.Hovered ) then
		return self.tex.Scroller.DownButton_Hover( 0, 0, w, h, self.colScrollBar )
	end

	self.tex.Scroller.DownButton_Normal( 0, 0, w, h, self.colScrollBar )
...
function SKIN:PaintButtonUp( panel, w, h )
	...
	if ( panel.Depressed || panel:IsSelected() ) then
		return self.tex.Scroller.UpButton_Down( 0, 0, w, h, self.colScrollBar )
	end

	if ( panel:GetDisabled() ) then
		return self.tex.Scroller.UpButton_Dead( 0, 0, w, h, self.colScrollBar )
	end

	if ( panel.Hovered ) then
		return self.tex.Scroller.UpButton_Hover( 0, 0, w, h, self.colScrollBar )
	end

	self.tex.Scroller.UpButton_Normal( 0, 0, w, h, self.colScrollBar )
...
function SKIN:PaintButtonLeft( panel, w, h )
	...
	if ( panel.Depressed || panel:IsSelected() ) then
		return self.tex.Scroller.LeftButton_Down( 0, 0, w, h, self.colScrollBar )
	end

	if ( panel:GetDisabled() ) then
		return self.tex.Scroller.LeftButton_Dead( 0, 0, w, h, self.colScrollBar )
	end

	if ( panel.Hovered ) then
		return self.tex.Scroller.LeftButton_Hover( 0, 0, w, h, self.colScrollBar )
	end

	self.tex.Scroller.LeftButton_Normal( 0, 0, w, h, self.colScrollBar )
...
function SKIN:PaintButtonRight( panel, w, h )
	...
	if ( panel.Depressed || panel:IsSelected() ) then
		return self.tex.Scroller.RightButton_Down( 0, 0, w, h, self.colScrollBar )
	end

	if ( panel:GetDisabled() ) then
		return self.tex.Scroller.RightButton_Dead( 0, 0, w, h, self.colScrollBar )
	end

	if ( panel.Hovered ) then
		return self.tex.Scroller.RightButton_Hover( 0, 0, w, h, self.colScrollBar )
	end

	self.tex.Scroller.RightButton_Normal( 0, 0, w, h, self.colScrollBar )
...
function SKIN:PaintSliderKnob(panel, w, h)
    ...
    draw.NoTexture()
    surface.DrawPoly({{x = w * 0.5, y = h}, {x = 0, y = 0}, {x = w, y = 0}})
    surface.SetDrawColor(10, 10, 10)
    draw.NoTexture()
    surface.DrawPoly({{x = w * 0.5, y = h * 0.8}, {x = 2, y = 1}, {x = w - 2, y = 1}})
end]]
