...
GM.ExtraHealthPerExtraNail = 100
GM.MaxNails = 4
...
GM.PoisonZombiePointRatio = 48 -- Has an enormous head hitbox
GM.HeadcrabZombiePointRatio = 21
GM.NoHeadboxZombiePointRatio = 30
GM.TorsoZombiePointRatio = 28
GM.LegsZombiePointRatio = 28
GM.SkeletonPointRatio = 32

SPEED_BASENORMAL = 229
SPEED_NORMAL = 230
...
GM.BarricadeHealthMax = 1650 * 0.95
GM.BarricadeHealthMassFactor = 3 * 1.45
GM.BarricadeHealthVolumeFactor = 5 * 0.95
GM.BarricadeRepairCapacity = 1.55

GM.BossZombiePlayersRequired = 5
GM.SecondBossZombiePlayersRequired = 17
...
GM.AmmoNames = {}
GM.AmmoNames["ar2"] = "Штурмовые"
GM.AmmoNames["pistol"] = "Пистолетные"
GM.AmmoNames["smg1"] = "Автоматные"
GM.AmmoNames["357"] = "Винтовичные"
GM.AmmoNames["xbowbolt"] = "Болты"
GM.AmmoNames["buckshot"] = "Картечь"
GM.AmmoNames["sniperround"] = "Доска"
GM.AmmoNames["grenade"] = "Граната"
GM.AmmoNames["thumper"] = "Авто. Турель"
GM.AmmoNames["battery"] = "Мед. Бакты"
GM.AmmoNames["gaussenergy"] = "Гвозди"
GM.AmmoNames["airboatgun"] = "Арсенал"
GM.AmmoNames["striderminigun"] = "Маяк Сообщения"
GM.AmmoNames["helicoptergun"] = "Амуниция"
GM.AmmoNames["slam"] = "Силовое Поле"
GM.AmmoNames["stone"] = "Камень"
GM.AmmoNames["flashbomb"] = "Свет. Граната"
GM.AmmoNames["betty"] = "Мина"
GM.AmmoNames["molotov"] = "Молотов"
GM.AmmoNames["manhack"] = "Манхак"
GM.AmmoNames["manhack_saw"] = "Манхак с пилой"
GM.AmmoNames["drone"] = "Дрон"
GM.AmmoNames["sigilfragment"] = "Маяк"
GM.AmmoNames["corruptedfragment"] = "Маяк Зомби"
GM.AmmoNames["mediccloudbomb"] = "Мед. Бомба"
GM.AmmoNames["nanitecloudbomb"] = "Ремонтная Бомба"
GM.AmmoNames["foodwatermelon"] = "Арбуз"
GM.AmmoNames["foodorange"] = "Апельсин"
GM.AmmoNames["foodbanana"] = "Банан"
GM.AmmoNames["foodsoda"] = "Напиток"
GM.AmmoNames["foodmilk"] = "Молоко"
GM.AmmoNames["foodtakeout"] = "Лапша"
GM.AmmoNames["foodwater"] = "Вода"
GM.AmmoNames["foodbeer"] = "Пиво"
GM.AmmoNames["pulse"] = "Импульсные"
GM.AmmoNames["impactmine"] = "Взрывчатки"
GM.AmmoNames["chemical"] = "Хим. Снаряды"
GM.AmmoNames["repairfield"] = "Ремонтное Поле"
GM.AmmoNames["zapper"] = "Жало"
GM.AmmoNames["zapper_arc"] = "Динамо"
GM.AmmoNames["remantler"] = "Верстак"
GM.AmmoNames["propmaker"] = "Создатель Пропов"
GM.AmmoNames["turret_buckshot"] = "Ракетная Турель"
GM.AmmoNames["turret_assault"] = "Штурм. Турель"
GM.AmmoNames["scrap"] = "Металл"
...
GM.AmmoModels["propmaker"] = "models/props_wasteland/buoy01.mdl"
...
GM.AmmoIcons["sniperround"] = "ammo_plank"
