...
CLASS.Health = 2350
CLASS.HealthPerWave = 65
CLASS.HealthPerHuman = 85
CLASS.Speed = 275
...
CLASS.ModelScale = 3
CLASS.Hull = {Vector(-6, -6, 0), Vector(6, 6, 7 * CLASS.ModelScale)}
CLASS.HullDuck = {Vector(-6, -6, 0), Vector(6, 6, 7 * CLASS.ModelScale)}
CLASS.ViewOffset = Vector(0, 0, 48)
CLASS.ViewOffsetDucked = Vector(0, 0, 48)
CLASS.StepSize = 25 * CLASS.ModelScale
