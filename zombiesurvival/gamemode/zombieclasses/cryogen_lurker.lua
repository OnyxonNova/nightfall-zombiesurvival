...
CLASS.Name = "Cryogen Lurker"
CLASS.TranslationName = "class_cryogen_lurker"
CLASS.Description = "description_cryogen_lurker"
CLASS.Help = "controls_cryogen_lurker"
...
CLASS.SWEP = "weapon_zs_cryogenlurker"
...
function CLASS:ProcessDamage(pl, dmginfo)
	if dmginfo:GetInflictor().IsMelee then
		dmginfo:SetDamage(dmginfo:GetDamage() / 1.85)
	end
end
...
function CLASS:PrePlayerDraw(pl)
	...
	render_SetColorModulation(0, 10, 5)
end
...
function CLASS:PrePlayerDrawModel(pl)
	render_ModelMaterialOverride("Models/Barnacle/barnacle_sheet")
end
