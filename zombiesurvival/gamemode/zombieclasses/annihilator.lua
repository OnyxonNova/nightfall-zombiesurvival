CLASS.Name = "Annihilator"
CLASS.TranslationName = "class_annihilator"
CLASS.Description = "description_annihilator"
CLASS.Help = "controls_annihilator"
...
function CLASS:PlayPainSound(pl)
    pl:EmitSound("npc/combine_soldier/pain" .. math_random(3) .. ".wav", 75, math.Rand(40, 50))
...
function CLASS:PlayDeathSound(pl)
    pl:EmitSound("npc/combine_gunship/gunship_pain.wav", 75, math.Rand(40, 50))
...
if SERVER then
    ...
    function CLASS:OnSpawned(pl)
        pl:CreateAmbience("annihilatorambience")
        pl.EradiVived = false
    end
end
...
CLASS.IconColor = Color(45, 0, 0)

local render_SetColorModulation = render.SetColorModulation
local render_SetMaterial = render.SetMaterial
local render_ModelMaterialOverride = render.ModelMaterialOverride
local angle_zero = angle_zero
local matSheet = Material("models/charple/Charple2_sheet")
